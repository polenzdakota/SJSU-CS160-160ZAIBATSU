...
for (cardAttrib in cardsJSON) {
	...
	var image = "";
	if (card.imageName) image = encodeURIComponent(card.imageName)+".hq.jpg";
	...
	"VALUES" +
	'(' + cardid + ',' + name + ',' + colors + ',' + cost + ',' + cmc + ',' + supertypes + ',' + types + ',' + subtypes + ',' + text + ',' + power + ',' + toughness + ',' + loyalty + ',' + '"/hoardr/img/' + image +'");' 
	);
	cardid++;
}
